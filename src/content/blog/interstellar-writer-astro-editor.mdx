...
description: "Editor de escritorio nativo construido en Rust para gestionar contenido MDX/Astro con edición visual de frontmatter YAML y sincronización con GitHub. Descubre cómo Rust y egui crean herramientas de desarrollo potentes."
image: ../../assets/imagesblog/interstellar-writer-header.svg
socialsTestUpdate: 2026-02-23
socialImage: ../../assets/imagesblog/interstellar-writer-social.jpg
tags:
  - Rust
  - Astro
  - MDX
