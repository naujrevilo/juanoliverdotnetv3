...
app.all("*", async (req, res) => {
  try {
    ...
    // Aggressive URL Rewrite
    // This handles various path prefixes (e.g. /.netlify/functions/tina/graphql, /tina/graphql, etc.)
    ...
    console.log(`URL Rewrite (Aggressive): ${originalUrl} -> ${req.url}`);
